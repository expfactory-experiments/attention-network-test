...
#'
#' \code{process_ant()} processes data files generated by the Attention Network Test experiment
#' (\url{https://expfactory.github.io/expfactory-experiments/attention_network_test}).
#'
#'\dontrun{
#'@examples
